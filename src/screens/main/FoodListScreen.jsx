  ...
  const categories = [
    {
      ...
      title: 'Breakfast',
      meals: [
        { id: 1, title: 'Avocado Toast', emoji: '🥑', rating: 4.8, time: 10, servings: 1, calories: 280 },
        { id: 2, title: 'Greek Yogurt Bowl', emoji: '🥣', rating: 4.6, time: 5, servings: 1, calories: 220 },
        { id: 3, title: 'Smoothie Bowl', emoji: '🍓', rating: 4.7, time: 15, servings: 1, calories: 320 },
        { id: 4, title: 'Oatmeal with Berries', emoji: '🥤', rating: 4.5, time: 8, servings: 1, calories: 250 },
        { id: 13, title: 'Berry Smoothie Bowl', emoji: '🍓', rating: 4.7, time: 10, servings: 1, calories: 320 },
        { id: 14, title: 'Eggs Benedict', emoji: '🥚', rating: 4.9, time: 25, servings: 2, calories: 450 },
      ],
    },
    {
      id: 'lunch',
      title: 'Lunch',
      meals: [
        { id: 5, title: 'Grilled Chicken Salad', emoji: '🥗', rating: 4.9, time: 20, servings: 1, calories: 320 },
        { id: 6, title: 'Quinoa Buddha Bowl', emoji: '🍚', rating: 4.7, time: 25, servings: 1, calories: 380 },
        { id: 7, title: 'Turkey Wrap', emoji: '🌯', rating: 4.4, time: 15, servings: 1, calories: 290 },
        { id: 8, title: 'Lentil Soup', emoji: '🍲', rating: 4.6, time: 30, servings: 2, calories: 240 },
        { id: 15, title: 'Falafel Wrap', emoji: '🌯', rating: 4.6, time: 15, servings: 1, calories: 440 },
        { id: 16, title: 'Chicken Caesar Salad', emoji: '🥗', rating: 4.8, time: 20, servings: 1, calories: 380 },
      ],
    },
    {
      id: 'dinner',
      title: 'Dinner',
      meals: [
        { id: 9, title: 'Baked Salmon', emoji: '🐟', rating: 4.8, time: 25, servings: 1, calories: 350 },
        { id: 10, title: 'Stir-Fry Vegetables', emoji: '🥦', rating: 4.5, time: 20, servings: 2, calories: 180 },
        { id: 11, title: 'Grilled Steak', emoji: '🥩', rating: 4.7, time: 15, servings: 1, calories: 420 },
        { id: 12, title: 'Pasta Primavera', emoji: '🍝', rating: 4.6, time: 30, servings: 2, calories: 380 },
        { id: 17, title: 'Honey Soy Salmon', emoji: '🍣', rating: 4.9, time: 25, servings: 2, calories: 420 },
        { id: 18, title: 'Vegetable Curry', emoji: '🥘', rating: 4.7, time: 35, servings: 4, calories: 380 },
      ],
    },
  ];
